...
export default function HomeHero() {
  return (
    <section className="relative overflow-hidden px-6 pb-2 pt-20 lg:px-10 lg:pb-4 lg:pt-24">
      <div className="relative min-h-[680px] lg:min-h-[760px]">
        <div className="relative z-20 flex flex-col justify-start pt-4 lg:pt-8">
          ...
          <div className="mt-8 w-full max-w-[320px] overflow-hidden rounded-[2.5rem] bg-[#f1cc00] lg:hidden">
            <img
        ...
        <div className="absolute right-0 top-0 z-10 hidden w-[38%] max-w-[520px] overflow-hidden rounded-[3rem] bg-[#f1cc00] lg:block">
          <img
            src={portfolioImages.hero}
            alt="Portrait of Jakub"
